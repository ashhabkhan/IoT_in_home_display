...
void onMsghandler(char *topic, uint8_t* msg, unsigned int msglen) {
  ...
  if (*(char *)msg == '0') updateLED1(0);
  else if (*(char *)msg == '1') updateLED1(1);
  if (*(char *)msg == '2') updateLED2(0);
  else if (*(char *)msg == '3') updateLED2(1);
  if (*(char *)msg == '4') updateLED3(0);
  else if (*(char *)msg == '5') updateLED3(1);
